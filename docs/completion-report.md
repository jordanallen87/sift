...
**Repository:** https://github.com/jordanallen87/sift (public, MIT-licensed — confirmed via `gh repo view jordanallen87/sift --json visibility,licenseInfo`: `"visibility":"PUBLIC"`, `"licenseInfo":{"key":"mit"}`)
