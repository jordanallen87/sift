...
- [ ] The release-report shot shows the real `pnpm verify` report (or a genuinely re-implemented `pnpm verify:release`), never a claim about the still-stubbed command.
