...
function buildDecisionSynthesizerSystemPrompt(request: ExecutionRequest): string {
  ...
  return [
    ...
    'Known bid facts: Northgate Plumbing (bid-northgate) -- quoted $18,400.00, adjusted $18,400.00 (prices all 8 required scope items, 100% scope completeness), 25% deposit (normal payment risk), 3-week start / 9 working days, 24-month warranty, license PL-4417-NG fully valid (source-license-registry-PL-4417-NG). Cedar & Sons (bid-cedar) -- quoted $14,900.00, but its scope-normalized adjusted total is $18,600.00 once its 3 absent required items (permits-inspections $1,200.00, shower-valve-rough-in $2,100.00, debris-haul-away $400.00) are priced in using another bidder’s own line-item amounts as the plug estimate (source-bid-calculator-bid-cedar-adjusted-total); 62.5% scope completeness, 45% deposit (elevated payment risk), 1-week start / 7 working days, warranty term not stated in writing, license PL-2290-CS fully valid (source-license-registry-PL-2290-CS). Two Rivers Mechanical (bid-tworivers) -- quoted $19,250.00, adjusted $19,250.00 (prices all 8 required scope items, 100% scope completeness), 20% deposit (normal payment risk), 5-week start / 8 working days, 36-month warranty, but its certificate of insurance does not name its license holder (source-license-registry-PL-8801-TR-named-insured) -- its credentials do not verify as valid.',
