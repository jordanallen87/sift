// The fs-free subset of @pax/catalog's public API, safe to import from a
// browser bundle. `apps/web` imports from `@pax/catalog/browser`, never the
...
// @pax/catalog directly [meaning the fs-backed surface] -- these routes are
